        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                    ...
                    switch ($action) {
                        case "insert";
                            $insert = "INSERT INTO 'Library'.'Monsters' ('MonsertName', 'MonsterAC', 'HitDice',"
                                    ."'MonsterAttack', 'MonsterDamage', 'MonsterMove', 'MonsterTreasure', 'MonsterXP', 'Active')"
                        ...
                        case "search";
                            ...
                            echo "<table class='table'><thead><th>Name</th><th>AC</th><th>HitDice</th><th>XP</th></thead><tbody>";
